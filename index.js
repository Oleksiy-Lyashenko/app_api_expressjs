...
// В данном примере мы сделали промежуточный обработчик на все приложение, котоырй выполняется при первом же запросе
...
// Данный middlewareпринимает все ошибки которые приходят их middleware и наших обработчиков и возращают эту функцию
